                    ...
                    <div class="col-md-12">
                      <div class="panel panel-default shadow-lg p-3 mb-5 rounded m-2 color-diferencial color-negro">
                        <div class="panel-title">
                            <h2 class="text-center  font-weight-bold py-1"><i class="fas fa-user-edit font-weight-bold"> Agregar autor</i></h1>  
                            </div>
                        <div class="panel-body py-2">
                          <form action="{{route('agregarAutor-admin.store')}}" method="POST">
                            @csrf
                            <div class="mb-4">
                                <label for="isbn" class="form-label">Nombre autor</label>
                                <input type="text" class="form-control" name="name">
                            </div>
                            @error('name')
                              <div class="alert alert-danger" role="alert">
                                *Nombre del autor es requerido
                              </div>

        ...
        <div class="d-flex" id="wrapper">
          ...
          <div class="border-end color-diferencial color-negro" id="sidebar-wrapper">
            ...
            <div class=" bg-light nav flex-column list-group">
              ...
              <a class=" nav-link active list-group-item list-group-item-action list-group-item-dark p-3" href="{{route('agregarCategoria-admin.index')}}" role="tab" aria-controls="v-pills-categorias" aria-selected="false"><i class="fas fa-th-large font-weight-bold"> Categorias</i></a>
            </div>
        </div>
                    ...
                    <div class="col-md-12">
                      <div class="panel panel-default shadow-lg p-3 mb-5 rounded m-2 color-diferencial color-negro">
                        <div class="panel-title">
                            <h2 class="text-center  font-weight-bold py-1"><i class="fas fa-th-large font-weight-bold"> Agregar categoria</i></h1>  
                        </div>
                        <div class="panel-body py-2">
                          <form action="{{route('agregarCategoria-admin.store')}}" method="POST">
                            @csrf
...
@if (session('agregado')== 'ok')
        ...
        <script>
          Swal.fire(
        'Agregado con exito!',
        'La categoria se agrego exitosamente.',
        'success')
        </script>
